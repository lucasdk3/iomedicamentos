String termos =
    '''Termos e condições gerais de uso do site ou aplicativo PosoloGuia Odonto

Os serviços do PosoloGuia Odonto são fornecidos pela pessoa física com a seguinte nome: Maiara Giongo Dotto, com nome fantasia PosoloGuia Odonto, inscrito no CPF sob o nº 069730589-90, titular da propriedade intelectual sobre software, website, aplicativos, conteúdos e demais ativos relacionados à plataforma PosoloGuia Odonto.
...
A plataforma caracteriza-se pela prestação do seguinte serviço: Aplicativo de terapêutica medicamentosa em Odontologia.
A plataforma realiza a venda à distância por meio eletrônico dos seguintes produtos ou serviços: Aplicativo de terapêutica medicamentosa voltado para a área da Odontologia que busca auxiliar acadêmicos de Odontologia e cirurgiões-dentistas durante a prescrição de medicamentos, anestésicos locais e profilaxia antibiótica para prevenção da endocardite bacteriana. 
...
O usuário poderá, a qualquer tempo, requerer o cancelamento de seu cadastro junto ao site ou aplicativo PosoloGuia Odonto. O seu descadastramento será realizado o mais rapidamente possível, desde que não sejam verificados débitos em aberto.
...
A plataforma poderá disponibilizar para o usuário um conjunto específico de funcionalidades e ferramentas para otimizar o uso dos serviços.
Na plataforma os serviços oferecidos estão descritos e apresentados com o maior grau de exatidão, contendo informações sobre suas características, qualidades, quantidades, composição, entre outros dados, bem como sobre os riscos que apresentam à saúde e segurança do usuário.
...
6. Do suporte
Em caso de qualquer dúvida, sugestão ou problema com a utilização da plataforma, o usuário poderá entrar em contato com o suporte, através do email maiarafgiongo@gmail.com  ou telefone 46-999001255.
Estes serviços de atendimento ao usuário estarão disponíveis nos seguintes dias e horários: segunda à sexta-feira das 8h às 18h.
...
É de responsabilidade da plataforma PosoloGuia Odonto:
...
O uso da plataforma pelo usuário é pessoal, individual e intransferível, sendo vedado qualquer uso não autorizado, comercial ou não-comercial. Tais usos consistirão em violação dos direitos de propriedade intelectual da razão social PosoloGuia Odonto, puníveis nos termos da legislação aplicável.

9. Das sanções
Sem prejuízo das demais medidas legais cabíveis, a razão social PosoloGuia Odonto poderá, a qualquer momento, advertir, suspender ou cancelar a conta do usuário:
...
10. Da rescisão
A não observância das obrigações pactuadas neste Termo de Uso ou da legislação aplicável poderá, sem prévio aviso, ensejar a imediata rescisão unilateral por parte da razão social PosoloGuia Odonto e o bloqueio de todos os serviços prestados ao usuário.

11. Das alterações
Os itens descritos no presente instrumento poderão sofrer alterações, unilateralmente e a qualquer tempo, por parte da equipe de trabalho do PosoloGuia Odonto, para adequar ou modificar os serviços, bem como para atender novas exigências legais. As alterações serão veiculadas OU pelo site ____ ou pelo aplicativo PosoloGuia Odonto e o usuário poderá optar por aceitar o novo conteúdo ou por cancelar o uso dos serviços, caso seja assinante de algum serviço.
